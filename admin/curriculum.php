...
<button class="bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl py-2.5 font-bold max-w-xs"><i class="fa fa-floppy-disk mr-1"></i>Simpan Kurikulum</button>
</form>
