...
$roleMap = [
  'administrator' => ['pages','posts','categories','media','gallery','announcements','agenda','teachers','students','ekskul','prestasi','structure','curriculum','vision','statistics','menus','megamenu','widgets','footer','sections','themes','appearance','settings','seo','users','logs'],
  'editor' => ['pages','posts','categories','media','gallery','announcements','agenda','teachers','students','ekskul','prestasi','structure','curriculum','vision','statistics','menus','megamenu','widgets','footer','sections','themes','appearance'],
