...
$roleMap = [
  'administrator' => ['pages','posts','categories','media','gallery','announcements','agenda','teachers','students','sarana','sarana-pembelajaran','ekskul','prestasi','structure','curriculum','vision','statistics','menus','megamenu','widgets','footer','sections','themes','appearance','settings','seo','users','logs','inbox'],
  'editor' => ['pages','posts','categories','media','gallery','announcements','agenda','teachers','students','sarana','sarana-pembelajaran','ekskul','prestasi','structure','curriculum','vision','statistics','menus','megamenu','widgets','footer','sections','themes','appearance','inbox'],
