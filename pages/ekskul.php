...
<nav class="text-xs text-emerald-100 mb-2"><a href="<?= Helper::url() ?>" class="hover:text-white">Beranda</a> / Ekstrakurikuler</nav>
<h1 class="text-3xl md:text-4xl font-extrabold">Ekstrakurikuler</h1>
<p class="text-emerald-50 mt-1 max-w-2xl">Kembangkan bakat dan minat di luar kelas.</p>
<div class="mt-4 text-sm"><span class="bg-white/15 px-3 py-1.5 rounded-full"><b><?= count($rows) ?></b> kegiatan aktif</span></div>
</div></div>
