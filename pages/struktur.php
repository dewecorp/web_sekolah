...
<div class="max-w-7xl mx-auto px-4 py-10"><nav class="text-xs text-slate-500 mb-3"><a href="<?= Helper::url() ?>">Beranda</a> / Struktur</nav><h1 class="text-3xl font-extrabold reveal">Struktur Organisasi</h1>
