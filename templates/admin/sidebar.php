<aside id="sidebar" class="hidden md:flex w-60 shrink-0 bg-gradient-to-b from-emerald-800 via-emerald-700 to-emerald-800 text-emerald-50 text-sm sticky flex-col shadow-lg">
...
<?= $link('admin/settings', 'fa-gear', 'Identitas & SEO') ?>
...
(function(){
  ...
  // sticky mengikuti tinggi navbar aktual (tanpa angka manual 57px)
  function fit(){if(!side||!top)return;var h=top.getBoundingClientRect().height;side.style.top=h+'px';side.style.height='calc(100vh - '+h+'px)'}
