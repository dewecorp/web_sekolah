...
<?php $favIcon=Database::setting('favicon','')?:Database::setting('logo',''); if($favIcon!==''): ?><link rel="icon" href="<?= Helper::e(Helper::upload($favIcon)) ?>"><?php else: ?><link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' rx='14' fill='%23059669'/%3E%3Ctext x='32' y='44' font-size='34' text-anchor='middle' fill='white' font-family='sans-serif' font-weight='bold'%3ES%3C/text%3E%3C/svg%3E"><?php endif; ?>
